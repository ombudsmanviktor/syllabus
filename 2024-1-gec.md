...
| Nomes  | Manipulação de Dados 1 | Manipulação de Dados 2 | Manipulação de Dados 3 | Manipulação de Dados 4 |
| ------------- | ------------- | ------------- | ------------- | ------------- |
| Thábata e Paulo  | -------------  | :white_check_mark: | A Entregar  |  A Entregar  |
| Amanda e Bruna  | -------------  | :white_check_mark: | A Entregar  |  A Entregar  |
| Ana Julia e Ana Clara  | -------------  | :white_check_mark: | A Entregar  |  A Entregar  |
| Ana Júlia e Ana Luiza  | -------------  | :white_check_mark: | A Entregar  |  A Entregar  |
| Beatriz e Thainá  | -------------  | :white_check_mark: (Thainá não entregou) | A Entregar  |  A Entregar  |
| Clara e Mavi  | -------------  | :white_check_mark: | A Entregar  |  A Entregar  |
| Isaque e Rafaela  | -------------  | :white_check_mark: | A Entregar  |  A Entregar  |
| Helena  | -------------  | :white_check_mark: | A Entregar  | A Entregar  |
| Fernanda  | -------------  | :white_check_mark: | A Entregar  | A Entregar  |
| Victor  | -------------  | :white_check_mark: | A Entregar  | A Entregar  |
| Katarina  | -------------  | :white_check_mark: | A Entregar  | A Entregar  |
| Gabriela  | -------------  | :white_check_mark: | A Entregar  | A Entregar  |
